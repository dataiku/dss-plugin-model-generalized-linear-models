...
def test_ave_grouped():
    ...
    assert_almost_equal(ave_grouped['Power'].mean().tolist(), check_ave_grouped['Power'], decimal=12)
    assert_almost_equal(ave_grouped['Density'].mean().tolist(), check_ave_grouped['Density'], decimal=12)
